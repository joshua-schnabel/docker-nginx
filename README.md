...
[![](https://img.shields.io/github/actions/workflow/status/joshua-schnabel/docker-nginx/docker.yml?branch=main)](https://github.com/joshua-schnabel/docker-nginx/actions?query=branch%3Amaster+workflow%3Adocker)
